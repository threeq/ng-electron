...
if (process.env.LIVE_UPDATE === "true") {
  index.commandLine.appendSwitch('remote-debugging-port', '8315');
...
index.on('ready', createWindow);

// Quit when all windows are closed.
index.on('window-all-closed', function () {
